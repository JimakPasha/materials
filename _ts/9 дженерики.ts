// Generics. Общие типы. Обозначение типов в общем виде. Позволяют создавать компоненты для работы с разными типами. Это позволяет применять такие компоненты и использовать свои типы, другими словами мы сами задаём типы и можем контролировать весь процесс.
