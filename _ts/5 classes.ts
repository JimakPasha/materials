...
// - private не имеет доступ за пределами класса. Ни наследники ни инстансы. (только в самом классе есть доступ)
// - protected не имеет доступ за пределами класса. Доступ могут получить только наследники, а инстансы нет. (в самом классе есть доступ)
